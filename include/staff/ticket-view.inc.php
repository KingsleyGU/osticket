           ...
           <tbody id="to_sec">
            <tr>
                ...
                <td>
                    ...
                    <a id="choose_all_threads_btn" style="display:none; text-decoration:none;" href="#" class="button">Choose all threads</a>
                </td>
...
<ul id="threads">
    ...
    <li><a style="padding-left:0px;" id="ticket_thread_detail" target="_blank" href="tickets.php?thread_detail=1&id=<?php echo $ticket->getId(); ?>"><?php echo sprintf(__('Ticket Thread detail')); ?></a></li>
</ul>
