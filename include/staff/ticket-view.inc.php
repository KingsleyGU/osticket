...
<ul id="threads">
    ...
    <li><a style="padding-left:10px;" id="ticket_thread_detail" href="tickets.php?thread_detail=1&id=<?php echo $ticket->getId(); ?>"><?php echo sprintf(__('Ticket Thread detail')); ?></a></li>
</ul>
