...
?>
    ...
    <form id="responza-Knowledge">
        <iframe src="http://erst.spitzeco.dk/contentkb/1_1/1/1/Search?customer=Erhvervsstyrelse&title=1_1&page=1&sparam=<?php echo Format::htmlchars($ticket->getSubject()); ?>" ></iframe>
    </form>
</div>
