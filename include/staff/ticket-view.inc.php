...
?>
        ...
        <p  style="padding:0 165px;">
            <input class="action-button btn-warning" type="submit" value="<?php echo __('Post Reply');?>" onClick="this.form.submit(); this.disabled=true;">
            <input class="action-button btn-warning" type="reset" value="<?php echo __('Reset');?>">
        </p>
    </form>
    <?php
    } ?>
